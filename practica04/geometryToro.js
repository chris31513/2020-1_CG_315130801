...
for (let i=0; i<16+1; i++) {
    for (let j=0; j<16; j++) {
        vertex.push(-(1 + r * Math.sin(2*Math.PI*j/16)) * Math.sin(2*Math.PI*i/16));
        vertex.push(r * Math.cos(2*Math.PI*j/16));
        vertex.push((1 + r * Math.sin(2*Math.PI*j/16)) * Math.cos(2*Math.PI*i/16));
    }
}
